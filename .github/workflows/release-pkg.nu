...
if $os in ['macos-latest'] or $USE_UBUNTU {
    ...
    match $target {
        ...
        'loongarch64-unknown-linux-gnu' => {
            ...
            # Workaround for Rust 1.87 TLS issues: unwind strategy to bypass TLS-dependent panic handling
            $env.RUSTFLAGS = "-C panic=unwind -C target-feature=+crt-static -C link-arg=-Wl,--allow-multiple-definition"
            cargo-build-nu
        }
